...
<?php include "leftBox.html";?>
	<div id="content" class="content">
		...
		<ul class="tab-list tab5">
			<li class="on" id="entitle"><a href="#">전체</a></li>
			<li id="general" onclick="alterClass(this)"><a href="reviewList.php?type='general'">일반직무</a></li>
			<li id="industry" onclick="alterClass(this)"><a href="reviewList.php?type='industry'">산업직무</a></li>
			<li id="common" onclick="alterClass(this)"><a href="reviewList.php?type='common'">공통역량</a></li>
			<li id="language" onclick="alterClass(this)"><a href="reviewList.php?type='language'">어학 및 자격증</a></li>
		</ul>
   ...
   if($cnt==0){
	   ...
	   <tr class="bbs-sbj">
		...
		<a href="04_수강후기_리스트.php?page=<?php echo ($total_page); ?>"><i class="icon-last"><span class="hidden">마지막페이지</span></i></a>	
		</div>
		<!-- <div class="box-paging">
