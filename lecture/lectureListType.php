...
<?php include "leftBox.html";?>
	<div id="content" class="content">
		...
		<ul class="tab-list tab5">
			<li ><a href="lectureList.php">전체</a></li>
			<li id="general"><a href="lectureListType.php?type='general'">일반직무</a></li>
			<li id="industry"><a href="lectureListType.php?type='industry'">산업직무</a></li>
			<li id="common"><a href="lectureListType.php?type='common'">공통역량</a></li>
			<li id="language"><a href="lectureListType.php?type='language'">어학 및 자격증</a></li>
		</ul>
		...
		<table border="0" cellpadding="0" cellspacing="0" class="tbl-bbs">
			...
			<tbody>
                ...
                <?php
                  $conn = mysqli_connect("14.49.30.84:30019", "gosi", "pservant148", "eland");
                  $type=$_GET["type"];
                  $query = "select * from project_1_admin where type=$type";
                  $result = mysqli_query($conn,$query);
                  $cnt = mysqli_num_rows($result);
				...
				$sql2 = "select * from project_1_admin where type=$type limit $start, $list_num;";
		...
		//////////////////////////////////////페이징/////////////////////////////////////////
			...
			<form action="deleteLecture.php" method="post" name="form" onsubmit="return deleteOK()">
				<tr class="bbs-sbj">
                    ...
                    <input type="hidden" id="theType" value="<?php echo "$type";  ?>">
					<td><?php echo "$no";  ?></td>
		...
		<p class="pager">
			...
			if($page <= 1){
			?>
			<a href="lectureListType.php?type='<?php echo "$type"?>'&page=1">이전</a>
			<?php } else{ ?>
			<a href="lectureListType.php?type='<?php echo "$type"?>'&page=<?php echo ($page-1); ?>">이전</a>
			<?php };?>
			...
			?>
			<a href="lectureListType.php?type='<?php echo "$type"?>'&page=<?php echo $print_page; ?>"><?php echo $print_page; ?></a>
			<?php };?>
			...
			if($page >= $total_page){
			?>
			<a href="lectureListType.php?type='<?php echo "$type"?>'&page=<?php echo $total_page; ?>">다음</a>
			<?php } else{ ?>
			<a href="lectureListType.php?type='<?php echo "$type"?>'&page=<?php echo ($page+1); ?>">다음</a>
			<?php };?>
